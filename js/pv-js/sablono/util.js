...
var len__8723__auto___32419 = arguments.length;
var i__8724__auto___32421 = (0);
while(true){
if((i__8724__auto___32421 < len__8723__auto___32419)){
args__8730__auto__.push((arguments[i__8724__auto___32421]));

var G__32426 = (i__8724__auto___32421 + (1));
i__8724__auto___32421 = G__32426;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq32416){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq32416));
});
...
var vec__32436 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
var seq__32437 = cljs.core.seq(vec__32436);
var first__32438 = cljs.core.first(seq__32437);
var seq__32437__$1 = cljs.core.next(seq__32437);
var first_word = first__32438;
var words = seq__32437__$1;
...
var G__32451 = clojure.set.rename_keys(m,kmap);
if(cljs.core.map_QMARK_(cljs.core.cst$kw$style.cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__32451,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$style], null),sablono.util.camel_case_keys);
} else {
return G__32451;
}
} else {
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.flatten(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32479_SHARP_){
if(typeof p1__32479_SHARP_ === 'string'){
return p1__32479_SHARP_;
} else {
return cljs.core.seq(p1__32479_SHARP_);
