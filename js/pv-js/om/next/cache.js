...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__32079 = cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(x,cljs.core.assoc,cljs.core.cst$kw$client_DASH_time,(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__32084 = self__.arr.shift();
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(self__.index,((function (id_SINGLEQUOTE__32084,x_SINGLEQUOTE__32079,this$){
return (function (p1__32019_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__32019_SHARP_,id_SINGLEQUOTE__32084),id,x_SINGLEQUOTE__32079);
});})(id_SINGLEQUOTE__32084,x_SINGLEQUOTE__32079,this$))
);
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__32079);
}
...
return (new om.next.cache.Cache([],(function (){var G__32094 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__32094) : cljs.core.atom.call(null,G__32094));
})(),size));
});
