...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(om.util.force_children),G__32036);
} else {
return G__32036;
}
});
om.util.union_QMARK_ = (function om$util$union_QMARK_(expr){
var expr__$1 = (function (){var G__32052 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__32052);
} else {
return G__32052;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__32067 = cljs.core.first(expr);
return (om.util.join_key.cljs$core$IFn$_invoke$arity$1 ? om.util.join_key.cljs$core$IFn$_invoke$arity$1(G__32067) : om.util.join_key.call(null,G__32067));
} else {
return expr;
...
var expr__$1 = (function (){var G__32093 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__32093);
} else {
return G__32093;
}
})();
