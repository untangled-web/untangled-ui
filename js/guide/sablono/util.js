...
var x__28368__auto__ = (((x == null))?null:x);
var m__28369__auto__ = (sablono.util.to_str[goog.typeOf(x__28368__auto__)]);
if(!((m__28369__auto__ == null))){
return m__28369__auto__.call(null,x);
} else {
var m__28369__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__28369__auto____$1 == null))){
return m__28369__auto____$1.call(null,x);
} else {
...
var x__28368__auto__ = (((x == null))?null:x);
var m__28369__auto__ = (sablono.util.to_uri[goog.typeOf(x__28368__auto__)]);
if(!((m__28369__auto__ == null))){
return m__28369__auto__.call(null,x);
} else {
var m__28369__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__28369__auto____$1 == null))){
return m__28369__auto____$1.call(null,x);
} else {
...
var len__28871__auto___691846 = arguments.length;
var i__28872__auto___691847 = (0);
while(true){
if((i__28872__auto___691847 < len__28871__auto___691846)){
args__28878__auto__.push((arguments[i__28872__auto___691847]));

var G__691854 = (i__28872__auto___691847 + (1));
i__28872__auto___691847 = G__691854;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__28879__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq691844){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq691844));
});
...
var vec__691866 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__691867 = cljs.core.seq.call(null,vec__691866);
var first__691868 = cljs.core.first.call(null,seq__691867);
var seq__691867__$1 = cljs.core.next.call(null,seq__691867);
var first_word = first__691868;
var words = seq__691867__$1;
...
var G__691881 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__691881,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__691881;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__691910_SHARP_){
if(typeof p1__691910_SHARP_ === 'string'){
return p1__691910_SHARP_;
} else {
return cljs.core.seq.call(null,p1__691910_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__27650__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1489703336310