...
var and__27638__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__27638__auto__){
var or__27650__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e712241){var e__688436__auto__ = e712241;
return false;
...
}catch (e712243){var e__688436__auto__ = e712243;
return false;
...
}catch (e712249){var e__688436__auto__ = e712249;
return false;
...
}catch (e712251){var e__688436__auto__ = e712251;
return false;
...
}catch (e712257){var e__688436__auto__ = e712257;
return false;
}})())){
...
}catch (e712259){var e__688436__auto__ = e712259;
return false;
}})())){
...
var _STAR_current_state_STAR_712262 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__27650__auto__ = config;
if(cljs.core.truth_(or__27650__auto__)){
return or__27650__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_712262;
}});
});
...
return (function() { 
var G__712265__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e712264){var e = e712264;
devtools.reporter.report_internal_error_BANG_.call(null,e,"an exception was raised during value formatting");

return null;
}};
var G__712265 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__712266__i = 0, G__712266__a = new Array(arguments.length -  0);
while (G__712266__i < G__712266__a.length) {G__712266__a[G__712266__i] = arguments[G__712266__i + 0]; ++G__712266__i;}
  args = new cljs.core.IndexedSeq(G__712266__a,0);
} 
return G__712265__delegate.call(this,args);};
G__712265.cljs$lang$maxFixedArity = 0;
G__712265.cljs$lang$applyTo = (function (arglist__712267){
var args = cljs.core.seq(arglist__712267);
return G__712265__delegate(args);
});
G__712265.cljs$core$IFn$_invoke$arity$variadic = G__712265__delegate;
return G__712265;
})()
;
});
...
var pre_handler = (function (){var or__27650__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__27650__auto__)){
return or__27650__auto__;
} else {
...
var post_handler = (function (){var or__27650__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__27650__auto__)){
return or__27650__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1489703360181