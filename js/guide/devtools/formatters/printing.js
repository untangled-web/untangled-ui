...
var len__28871__auto___711837 = arguments.length;
var i__28872__auto___711838 = (0);
while(true){
if((i__28872__auto___711838 < len__28871__auto___711837)){
args__28878__auto__.push((arguments[i__28872__auto___711838]));

var G__711840 = (i__28872__auto___711838 + (1));
i__28872__auto___711838 = G__711840;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28879__auto__);
});
...
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Assert failed: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1([cljs.core.str.cljs$core$IFn$_invoke$arity$1("missing markup method in markup-db: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(fn_key)].join('')),cljs.core.str.cljs$core$IFn$_invoke$arity$1("\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("f")].join('')));
}
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq711832){
var G__711833 = cljs.core.first.call(null,seq711832);
var seq711832__$1 = cljs.core.next.call(null,seq711832);
var G__711834 = cljs.core.first.call(null,seq711832__$1);
var seq711832__$2 = cljs.core.next.call(null,seq711832__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__711833,G__711834,seq711832__$2);
});
...
if(cljs.core.truth_((function (){var or__27650__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__28307__auto__,writer__28308__auto__,opt__28309__auto__){
return cljs.core._write.call(null,writer__28308__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__27638__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__27638__auto__){
var or__27650__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__27650__auto__)){
return or__27650__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__711877_SHARP_){
return !((cljs.core.meta.call(null,p1__711877_SHARP_) == null));
})))){
...
var map__711921 = opts;
var map__711921__$1 = ((((!((map__711921 == null)))?((((map__711921.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__711921.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__711921):map__711921);
var markup_db = cljs.core.get.call(null,map__711921__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__27650__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e711925){var e__688436__auto__ = e711925;
return false;
}})();
if(cljs.core.truth_(or__27650__auto__)){
return or__27650__auto__;
...
}catch (e711927){var e__688436__auto__ = e711927;
return false;
}}
})())){
...
var _STAR_current_state_STAR_711942 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__711943 = opts;
var map__711943__$1 = ((((!((map__711943 == null)))?((((map__711943.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__711943.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__711943):map__711943);
var markup_db = cljs.core.get.call(null,map__711943__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_711942;
}});
...
;
var temp__6751__auto___711957 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6751__auto___711957)){
var managed_print_level_711958 = temp__6751__auto___711957;
var _STAR_print_level_STAR_711956_711959 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_711958;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_711956_711959,managed_print_level_711958,temp__6751__auto___711957,writer,opts,job_fn){
return (function (p1__711953_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__711953_SHARP_,null);
});})(_STAR_print_level_STAR_711956_711959,managed_print_level_711958,temp__6751__auto___711957,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_711956_711959;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1489703359322