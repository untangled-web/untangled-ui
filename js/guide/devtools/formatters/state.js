...
var len__28871__auto___709672 = arguments.length;
var i__28872__auto___709673 = (0);
while(true){
if((i__28872__auto___709673 < len__28871__auto___709672)){
args__28878__auto__.push((arguments[i__28872__auto___709673]));

var G__709676 = (i__28872__auto___709673 + (1));
i__28872__auto___709673 = G__709676;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28879__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq709666){
var G__709667 = cljs.core.first.call(null,seq709666);
var seq709666__$1 = cljs.core.next.call(null,seq709666);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__709667,seq709666__$1);
});
...
return (function (p1__709705_SHARP_){
return (p1__709705_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1489703356453