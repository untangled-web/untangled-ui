...
var G__711795 = devtools.prefs.pref.call(null,v);
v = G__711795;
continue;
} else {
return v;
...
var and__27638__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__27638__auto__){
var and__27638__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__27650__auto__ = (function (){try{if(!((value == null))){
...
}catch (e711808){var e__688436__auto__ = e711808;
return false;
}})();
if(cljs.core.truth_(or__27650__auto__)){
return or__27650__auto__;
} else {
var or__27650__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e711812){var e__688436__auto__ = e711812;
return false;
}})();
...
}catch (e711814){var e__688436__auto__ = e711814;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__27638__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__27638__auto__)){
var and__27638__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__27638__auto____$1){
...
var and__27638__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__27638__auto__)){
...
var or__27650__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__27650__auto__)){
return or__27650__auto__;
} else {
...
var and__27638__auto__ = (function (){var or__27650__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__27650__auto__)){
return or__27650__auto__;
} else {
...
var vec__711819 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__711819,(0),null);
var name = cljs.core.nth.call(null,vec__711819,(1),null);
var fully_qualified_type_name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(ns),cljs.core.str.cljs$core$IFn$_invoke$arity$1("/"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
...
var and__27638__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__27638__auto__)){
...
var or__27650__auto__ = typeof value === 'string';
if(or__27650__auto__){
return or__27650__auto__;
} else {
var or__27650__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__711822_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__711822_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1489703359173