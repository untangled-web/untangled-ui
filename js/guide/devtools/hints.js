...
var reader = (function (){var or__27650__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__27650__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__27650__auto__)){
return or__27650__auto__;
} else {
return (128);
...
var map__711787 = top_item;
var map__711787__$1 = ((((!((map__711787 == null)))?((((map__711787.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__711787.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__711787):map__711787);
var file = cljs.core.get.call(null,map__711787__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__711787__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__711787__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e711786){var _e = e711786;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6751__auto___711789 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6751__auto___711789)){
var seen_errors_711790 = temp__6751__auto___711789;
if(cljs.core.truth_(seen_errors_711790.has(self))){
} else {
seen_errors_711790.add(self);

var temp__6753__auto___711791 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6753__auto___711791)){
var sense_711792 = temp__6753__auto___711791;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_711792)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1489703359069