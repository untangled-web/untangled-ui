...
return (new CustomEvent(event_name,(function (){var obj706322 = {"detail":data};
return obj706322;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__27638__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__27638__auto__)){
var and__27638__auto____$1 = (window["CustomEvent"]);
...
var args706345 = [];
var len__28871__auto___706405 = arguments.length;
var i__28872__auto___706406 = (0);
while(true){
if((i__28872__auto___706406 < len__28871__auto___706405)){
args706345.push((arguments[i__28872__auto___706406]));

var G__706407 = (i__28872__auto___706406 + (1));
i__28872__auto___706406 = G__706407;
continue;
} else {
}
break;
...
var G__706389 = args706345.length;
switch (G__706389) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args706345.length)].join('')));
...
var f = (function (){var pred__706391 = cljs.core._EQ_;
var expr__706392 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__706391.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__706392))){
return ((function (pred__706391,expr__706392){
return (function (p1__706341_SHARP_){
return console.warn(p1__706341_SHARP_);
});
;})(pred__706391,expr__706392))
} else {
if(cljs.core.truth_(pred__706391.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__706392))){
return ((function (pred__706391,expr__706392){
return (function (p1__706342_SHARP_){
return console.debug(p1__706342_SHARP_);
});
;})(pred__706391,expr__706392))
} else {
if(cljs.core.truth_(pred__706391.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__706392))){
return ((function (pred__706391,expr__706392){
return (function (p1__706343_SHARP_){
return console.error(p1__706343_SHARP_);
});
;})(pred__706391,expr__706392))
} else {
return ((function (pred__706391,expr__706392){
return (function (p1__706344_SHARP_){
return console.log(p1__706344_SHARP_);
});
;})(pred__706391,expr__706392))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__706422){
var map__706429 = p__706422;
var map__706429__$1 = ((((!((map__706429 == null)))?((((map__706429.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__706429.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__706429):map__706429);
var opts = map__706429__$1;
var eval_fn = cljs.core.get.call(null,map__706429__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__706450_SHARP_){
return new_def.callback(p1__706450_SHARP_);
});})(new_def))
);
...
return (function (p__706468){
var vec__706469 = p__706468;
var ky = cljs.core.nth.call(null,vec__706469,(0),null);
var v = cljs.core.nth.call(null,vec__706469,(1),null);
...
var args706500 = [];
var len__28871__auto___706516 = arguments.length;
var i__28872__auto___706517 = (0);
while(true){
if((i__28872__auto___706517 < len__28871__auto___706516)){
args706500.push((arguments[i__28872__auto___706517]));

var G__706518 = (i__28872__auto___706517 + (1));
i__28872__auto___706517 = G__706518;
continue;
} else {
}
break;
...
var G__706509 = args706500.length;
switch (G__706509) {
case 2:
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args706500.length)].join('')));
...
if(cljs.core.truth_((function (){var and__27638__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1489703354719