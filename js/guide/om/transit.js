...
om.transit.TempIdHandler.cljs$lang$ctorPrWriter = (function (this__28307__auto__,writer__28308__auto__,opt__28309__auto__){
return cljs.core._write.call(null,writer__28308__auto__,"om.transit/TempIdHandler");
});
...
var args693376 = [];
var len__28871__auto___693382 = arguments.length;
var i__28872__auto___693383 = (0);
while(true){
if((i__28872__auto___693383 < len__28871__auto___693382)){
args693376.push((arguments[i__28872__auto___693383]));

var G__693384 = (i__28872__auto___693383 + (1));
i__28872__auto___693383 = G__693384;
continue;
} else {
}
break;
...
var G__693378 = args693376.length;
switch (G__693378) {
case 0:
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args693376.length)].join('')));
...
var args693386 = [];
var len__28871__auto___693392 = arguments.length;
var i__28872__auto___693393 = (0);
while(true){
if((i__28872__auto___693393 < len__28871__auto___693392)){
args693386.push((arguments[i__28872__auto___693393]));

var G__693394 = (i__28872__auto___693393 + (1));
i__28872__auto___693393 = G__693394;
continue;
} else {
}
break;
...
var G__693390 = args693386.length;
switch (G__693390) {
case 0:
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args693386.length)].join('')));
...
//# sourceMappingURL=transit.js.map?rel=1489703337403