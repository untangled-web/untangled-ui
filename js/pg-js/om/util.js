...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(om.util.force_children),G__33217);
} else {
return G__33217;
}
});
om.util.union_QMARK_ = (function om$util$union_QMARK_(expr){
var expr__$1 = (function (){var G__33219 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__33219);
} else {
return G__33219;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__33221 = cljs.core.first(expr);
return (om.util.join_key.cljs$core$IFn$_invoke$arity$1 ? om.util.join_key.cljs$core$IFn$_invoke$arity$1(G__33221) : om.util.join_key.call(null,G__33221));
} else {
return expr;
...
var expr__$1 = (function (){var G__33223 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__33223);
} else {
return G__33223;
}
})();
