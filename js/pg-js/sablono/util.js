...
var m__8221__auto__ = (sablono.util.to_str[goog.typeOf(x__8220__auto__)]);
...
var m__8221__auto____$1 = (sablono.util.to_str["_"]);
...
var x__8220__auto__ = (((x == null))?null:x);
var m__8221__auto__ = (sablono.util.to_uri[goog.typeOf(x__8220__auto__)]);
if(!((m__8221__auto__ == null))){
return (m__8221__auto__.cljs$core$IFn$_invoke$arity$1 ? m__8221__auto__.cljs$core$IFn$_invoke$arity$1(x) : m__8221__auto__.call(null,x));
} else {
var m__8221__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__8221__auto____$1 == null))){
return (m__8221__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__8221__auto____$1.cljs$core$IFn$_invoke$arity$1(x) : m__8221__auto____$1.call(null,x));
} else {
...
var len__8723__auto___33160 = arguments.length;
var i__8724__auto___33161 = (0);
while(true){
if((i__8724__auto___33161 < len__8723__auto___33160)){
args__8730__auto__.push((arguments[i__8724__auto___33161]));

var G__33162 = (i__8724__auto___33161 + (1));
i__8724__auto___33161 = G__33162;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__8731__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq33159){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq33159));
});
...
var vec__33166 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
var seq__33167 = cljs.core.seq(vec__33166);
var first__33168 = cljs.core.first(seq__33167);
var seq__33167__$1 = cljs.core.next(seq__33167);
var first_word = first__33168;
var words = seq__33167__$1;
...
var G__33170 = clojure.set.rename_keys(m,kmap);
if(cljs.core.map_QMARK_(cljs.core.cst$kw$style.cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__33170,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$style], null),sablono.util.camel_case_keys);
} else {
return G__33170;
}
} else {
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.flatten(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33171_SHARP_){
if(typeof p1__33171_SHARP_ === 'string'){
return p1__33171_SHARP_;
} else {
return cljs.core.seq(p1__33171_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__7502__auto__ = x__$1.hasDomain();
