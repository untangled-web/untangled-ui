...
var G__47620 = ({"displayName": [cljs.core.str.cljs$core$IFn$_invoke$arity$1("wrapped-"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(element)].join(''), "getInitialState": (function (){
var this$ = this;
return ({"state_value": (function (){var G__47621 = (this$.props[property]);
return (coerce.cljs$core$IFn$_invoke$arity$1 ? coerce.cljs$core$IFn$_invoke$arity$1(G__47621) : coerce.call(null,G__47621));
})()});
}), "onChange": (function (e){
var this$ = this;
...
return this$.setState(({"state_value": (function (){var G__47622 = (new_props[property]);
return (coerce.cljs$core$IFn$_invoke$arity$1 ? coerce.cljs$core$IFn$_invoke$arity$1(G__47622) : coerce.call(null,G__47622));
})()}));
}
}), "render": (function (){
var this$ = this;
var element_props = ({});
var G__47623_47626 = element_props;
var G__47624_47627 = this$.props;
var G__47625_47628 = ({"onChange": (this$["onChange"]), "children": (this$.props["children"])});
goog.object.extend(G__47623_47626,G__47624_47627,G__47625_47628);

(element_props[property] = (this$.state["state_value"]));

return React.createElement(element,element_props);
})});
return React.createClass(G__47620);
});
...
var len__8723__auto___47636 = arguments.length;
var i__8724__auto___47637 = (0);
while(true){
if((i__8724__auto___47637 < len__8723__auto___47636)){
args__8730__auto__.push((arguments[i__8724__auto___47637]));

var G__47638 = (i__8724__auto___47637 + (1));
i__8724__auto___47637 = G__47638;
continue;
} else {
}
break;
...
var class$ = (function (){var or__7502__auto__ = ((!((props == null)))?(function (){var G__47634 = cljs.core.name(type);
switch (G__47634) {
case "input":
var G__47635 = props.type;
switch (G__47635) {
case "radio":
...
sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq47629){
var G__47630 = cljs.core.first(seq47629);
var seq47629__$1 = cljs.core.next(seq47629);
var G__47631 = cljs.core.first(seq47629__$1);
var seq47629__$2 = cljs.core.next(seq47629__$1);
return sablono.interpreter.create_element.cljs$core$IFn$_invoke$arity$variadic(G__47630,G__47631,seq47629__$2);
});
...
var vec__47644 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47644,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47644,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47644,(2),null);
