...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(node,cljs.core.cst$kw$content,(function (){var and__7490__auto__ = children;
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__35915 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35915,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35915,(1),null);
var vec__35918 = clojure.zip.children(loc);
var seq__35919 = cljs.core.seq(vec__35918);
var first__35920 = cljs.core.first(seq__35919);
var seq__35919__$1 = cljs.core.next(seq__35919);
var c = first__35920;
var cnext = seq__35919__$1;
var cs = vec__35918;
...
var vec__35926 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35926,(0),null);
var map__35929 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35926,(1),null);
...
var path = map__35929__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35929__$1,cljs.core.cst$kw$l);
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35929__$1,cljs.core.cst$kw$ppath);
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35929__$1,cljs.core.cst$kw$pnodes);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35929__$1,cljs.core.cst$kw$r);
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35929__$1,cljs.core.cst$kw$changed_QMARK_);
if(cljs.core.truth_(pnodes)){
var pnode = cljs.core.peek(pnodes);
return cljs.core.with_meta((cljs.core.truth_(changed_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node(loc,pnode,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(l,cljs.core.cons(node,r))),(function (){var and__7490__auto__ = ppath;
if(cljs.core.truth_(and__7490__auto__)){
...
var vec__35940 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35940,(0),null);
var map__35943 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35940,(1),null);
...
var path = map__35943__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35943__$1,cljs.core.cst$kw$l);
var vec__35944 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35943__$1,cljs.core.cst$kw$r);
var seq__35945 = cljs.core.seq(vec__35944);
var first__35946 = cljs.core.first(seq__35945);
var seq__35945__$1 = cljs.core.next(seq__35945);
var r = first__35946;
var rnext = seq__35945__$1;
var rs = vec__35944;
if(cljs.core.truth_((function (){var and__7490__auto__ = path;
if(cljs.core.truth_(and__7490__auto__)){
return rs;
} else {
return and__7490__auto__;
...
var vec__35953 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35953,(0),null);
var map__35956 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35953,(1),null);
...
var path = map__35956__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35956__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35956__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__7490__auto__ = path;
if(cljs.core.truth_(and__7490__auto__)){
return r;
} else {
...
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35966__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35966__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__7490__auto__ = path;
if(cljs.core.truth_(and__7490__auto__)){
...
var vec__35973 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35973,(0),null);
var map__35976 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35973,(1),null);
var map__35976__$1 = ((((!((map__35976 == null)))?((((map__35976.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__35976.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__35976):map__35976);
var path = map__35976__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35976__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35976__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__7490__auto__ = path;
if(cljs.core.truth_(and__7490__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__35983 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35983,(0),null);
var map__35986 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35983,(1),null);
...
var path = map__35986__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35986__$1,cljs.core.cst$kw$l);
if((path == null)){
throw "Insert at top";
} else {
...
var vec__35993 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35993,(0),null);
var map__35996 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35993,(1),null);
var map__35996__$1 = ((((!((map__35996 == null)))?((((map__35996.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__35996.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__35996):map__35996);
var path = map__35996__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35996__$1,cljs.core.cst$kw$r);
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36001,(1),null);
...
var len__8723__auto___36007 = arguments.length;
var i__8724__auto___36008 = (0);
while(true){
if((i__8724__auto___36008 < len__8723__auto___36007)){
args__8730__auto__.push((arguments[i__8724__auto___36008]));

var G__36009 = (i__8724__auto___36008 + (1));
i__8724__auto___36008 = G__36009;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8731__auto__);
});
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(G__36005,G__36006,seq36004__$2);
});
...
var or__7502__auto__ = (function (){var and__7490__auto__ = clojure.zip.branch_QMARK_(loc);
if(cljs.core.truth_(and__7490__auto__)){
...
var or__7502__auto____$1 = clojure.zip.right(loc);
...
var or__7502__auto____$2 = clojure.zip.right(clojure.zip.up(p));
if(cljs.core.truth_(or__7502__auto____$2)){
return or__7502__auto____$2;
} else {
var G__36010 = clojure.zip.up(p);
p = G__36010;
continue;
}
} else {
...
var loc__$1 = lloc;
while(true){
var temp__6751__auto____$1 = (function (){var and__7490__auto__ = clojure.zip.branch_QMARK_(loc__$1);
if(cljs.core.truth_(and__7490__auto__)){
...
var G__36011 = clojure.zip.rightmost(child);
loc__$1 = G__36011;
continue;
} else {
return loc__$1;
...
var vec__36017 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36017,(0),null);
var map__36020 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36017,(1),null);
...
var path = map__36020__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36020__$1,cljs.core.cst$kw$l);
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36020__$1,cljs.core.cst$kw$ppath);
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36020__$1,cljs.core.cst$kw$pnodes);
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36020__$1,cljs.core.cst$kw$r);
if((path == null)){
throw "Remove at top";
} else {
...
while(true){
var temp__6751__auto__ = (function (){var and__7490__auto__ = clojure.zip.branch_QMARK_(loc__$1);
if(cljs.core.truth_(and__7490__auto__)){
return clojure.zip.down(loc__$1);
} else {
return and__7490__auto__;
...
var G__36022 = clojure.zip.rightmost(child);
loc__$1 = G__36022;
continue;
} else {
return loc__$1;
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node(loc,cljs.core.peek(pnodes),rs),(function (){var and__7490__auto__ = ppath;
if(cljs.core.truth_(and__7490__auto__)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ppath,cljs.core.cst$kw$changed_QMARK_,true);
} else {
return and__7490__auto__;
